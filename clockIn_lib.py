...
class clockIn():
    ...
    def step3(self):
        ...
        reserve2 = json.loads(self.reserve_lib_seat(cookie, tomorrow, '13:00:00', '17:00:00'))
        reserve3 = json.loads(self.reserve_lib_seat(cookie, tomorrow, '17:00:00', '21:00:00'))
